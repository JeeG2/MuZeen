...
<!DOCTYPE html>
    ...
    <body>
        ...
        <header class="header">
            <div class="header__container">
                ...
                <a href="home.php" class="header__logo">Buy Tickets</a>
            ...
            <nav class="nav__container">
                <div>
                    <a href="home.php" class="nav__link nav__logo">
                        ...
                        <span class="nav__logo-name">Buy Tickets</span>
                    </a>
                    ...
                    <div class="nav__list">
                            ...
                            <div class="nav__dropdown">
                                ...
                                <div class="nav__dropdown-collapse">
                                    <div class="nav__dropdown-content">
                                        <a href="#" class="nav__dropdown-item">Rates</a>
                                        <a href="#" class="nav__dropdown-item">Weather</a>
                                        <a href="#" class="nav__dropdown-item">distance</a>
                                    </div>
                                </div>
                        ...
                        <div class="nav__items">
                            ...
                            <div class="nav__dropdown">
                                <a href="#" class="nav__link">
                                    ...
                                    <span class="nav__name">Other Locations</span>
                                    <i class='bx bx-chevron-down nav__icon nav__dropdown-icon'></i>
                                </a>

                                <div class="nav__dropdown-collapse">
                                    <div class="nav__dropdown-content">
                                        <a href="subj1.php" class="nav__dropdown-item">Basilica of Collemaggio</a>
                                        <a href="#" class="nav__dropdown-item">fontana delle 99 cannelle</a>
                                        <a href="#" class="nav__dropdown-item">pisa tower</a>
                                    </div>
                                </div>
                              </div>
                        ...
                        <div class="nav__dropdown">
                                ...
                                <div class="nav__dropdown-collapse">
                                    <div class="nav__dropdown-content">
                                        <a href="https://en.wikipedia.org/wiki/Forte_Spagnolo,_L%27Aquila" class="nav__dropdown-item">More Details</a>
                                        <a href="#" class="nav__dropdown-item">Customer questions & answers</a>
  ...
  <div class="card">
    ...
    <div class="general">
      <h2>Jane Doe</h2>
      <p>In the 15th century, L'Aquila had become the second most powerful city in the Kingdom of Naples after Naples itself: there were half a million sheep</p>
  ...
  <div class="card green">
    ...
    <div class="general">
      <h1>Jane Doe</h1>
      <p>wool and saffron were exported throughout Europe; all this was lost when the Aquilans, during the war between the French and the Spaniards for the throne of Naples, sided with the French. In 1504 Aquila was occupied by the Spanish conquerors.</p>
      <span class="more">Mouse over the card for more info</span>
    </div>
  </div>
  ...
  <div class="card green">
    ...
    <div class="general">
      <h1>Jane Doe</h1>
      <p>
          though in 1527 the French recovered the city with the support of the citizens and the surrounding town. One year later Viceroy Philibert of Orange, ruling for King Charles V of Spain.</p>
      <span class="more">Mouse over the card for more info</span>
    </div>
  </div>
  ...
  <div class="card green">
    ...
    <div class="general">
      <h1>Jane Doe</h1>
      <p>finally defeated the Aquilan rebels and ordered the city to build a fortress in the highest spot North of the city, exactly where in 1401 King Ladislaus had built a garrison to control the unruly and rebellious Aquilans..</p>
      <span class="more">Mouse over the card for more info</span>
    </div>
  </div>
</div>         
